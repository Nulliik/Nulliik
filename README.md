...
Projects listed here are my hobby projects that I am working on free time. Currently I am focused on **decentralized peer-to-peer networking**, **cross-platform applications**, **embedded firmware**, and **local AI/LLM inference**. Lately I actively started using LLM's in my projects,.
...
### 📟 [SSD1306_library](https://github.com/MaxFlatline/SSD1306_library) — Embedded OLED Display Library with demo realization for STM32L0. Written to be fast portable to any MCU
